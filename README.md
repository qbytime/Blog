...
###[View Live Qiby's Blog &rarr;](https://huangxuan.me)
...
```
# Site settings
title: Qiby's Blog             # title of your website
SEOTitle: Qiby's Blog			# check out docs for more detail
...
It's possible that you want the two things different. For me, my site-title is **“Qiby's Blog”** but I want the title shows in search engine is **“黄玄的博客 | Qiby's Blog”** which is multi-language.
...
Qiby's Blog is derived from [Clean Blog Jekyll Theme (MIT License)](https://github.com/BlackrockDigital/startbootstrap-clean-blog-jekyll/)
